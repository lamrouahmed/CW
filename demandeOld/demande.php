<?php
   ...
   $lavage = new lavage();
   $currentLavage = $lavage->getLavage('Normale')->results();
   if(Input::get('type')) {
     $type = ucfirst(Input::get('type'));
     if($lavage->getLavage($type)->count() !== 0) {
       $currentLavage = $lavage->getLavage($type)->results();
     }
   }
 ?>
...
<body>
  <div class="reservation">
    ...
    <h2 class="type_lavage">Lavage <?php echo $currentLavage[0]->type_lavage ?></h2>
